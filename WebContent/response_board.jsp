...
<%@include file="db_conn.jsp"%>
	<%
	    ...
	    String count_sql = "select count(*) from response_board";
	    ...
	    String list_sql = "select * from response_board";
	...
	<table class="board" border="1">
		...
		<tbody>
			...
			<% }
						...
						<tr>
							<td>숫자임</td>
							<td><a href="response_board_content.jsp?board_no=<%=board_no%>"><%= title %></a></td>
							<td><%= id %></td>
							<td><%= date %></td>
						</tr>
			<% 		} 
